...
namespace Win32.Interop
{
   ...
   {
       public static void AdjustPrivileges(string p_PrivilegeName,
           PrivilegeAction p_PrivilegeAction = PrivilegeAction.Enable)
       {
           ...
           try
           {
               ...
               success = SecurityImportedFunctions.OpenProcessToken(process,
                   Constants.TOKEN_ADJUST_PRIVILEGES | Constants.TOKEN_QUERY, out token);
               if (!success)
               {
               ...
               success = SecurityImportedFunctions.LookupPrivilegeValue(null, p_PrivilegeName,
               ...
               success = SecurityImportedFunctions.AdjustTokenPrivileges(
